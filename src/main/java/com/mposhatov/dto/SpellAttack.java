...
public class SpellAttack extends Spell {
    ...
    public SpellAttack(Long id, String name, String description, String pictureName, Target target, Integer mana, Integer purchaseCostGoldCoins, Integer purchaseCostDiamonds, Integer updateCostGoldCoins, Integer updateCostDiamonds, Integer requirementHeroLevel, Integer damage, Integer damageBySpellPower, Integer requirementSpellPower, SpellAttack parentSpellAttack, List<SpellAttack> childrenSpellAttacks) {
